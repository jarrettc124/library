...
class NetworkUtil{
    ...
    static let backendVersion:String = "1.1"
    
    static let NetworkErrorStatusCodeKey:String = "NetworkErrorStatusCodeKey"
    static let NetworkErrorDomain:String = "NetworkErrorDomain"
